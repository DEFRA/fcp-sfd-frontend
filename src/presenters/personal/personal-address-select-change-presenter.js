/**
 * Formats data ready for presenting in the `/personal-address-select-change` page
 * @module personalAddressSelectChangePresenter
 */

const personalAddressSelectChangePresenter = (data) => {
  return {
    ...
    postcode: data.changePersonalPostcode.personalPostcode,
    displayAddresses: formatDisplayAddresses(data.changePersonalAddresses)
  }
}
...
export {
  personalAddressSelectChangePresenter
}

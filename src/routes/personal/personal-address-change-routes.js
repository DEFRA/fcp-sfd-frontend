...
import { personalUkPostcodeSchema } from '../../schemas/personal/personal-uk-postcode-schema.js'
...
const postPersonalAddressChange = {
  ...
  options: {
    validate: {
      payload: personalUkPostcodeSchema,
  ...
  handler: async (request, h) => {
    ...
    const addresses = await addressLookupService(payload.personalPostcode, yar, 'personal')

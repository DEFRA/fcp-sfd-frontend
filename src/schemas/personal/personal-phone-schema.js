...
export const personalPhoneSchema = Joi.object({
  personalTelephone: Joi.string()
    ...
    .messages({
      ...
      'string.pattern.base': 'Personal telephone number must only include numbers 0 to 9 and special characters such as spaces, brackets and + (if included, + must be at the start)'
    }),
  personalMobile: Joi.string()
    ...
    .messages({
      ...
      'string.pattern.base': 'Personal mobile phone number must only include numbers 0 to 9 and special characters such as spaces, brackets and + (if included, + must be at the start)'
    })
})

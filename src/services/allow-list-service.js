...
const allowListMap = {
  woodlandManagement: {
    crn: 'allowLists.woodlandManagementAllowListCrns',
    sbi: 'allowLists.woodlandManagementAllowListSbis'
  }
}
...
const getAllowList = (scheme, type) => {
  ...
  // i.e if schema is 'woodlandManagement' and type is 'crn', the config key would be 'allowLists.woodlandManagementAllowListCrns'

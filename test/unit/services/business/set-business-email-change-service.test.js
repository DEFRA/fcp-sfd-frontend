...
// Thing under test
import { setBusinessEmailChangeService } from '../../../../src/services/business/set-business-email-change-service'
...
describe('setBusinessEmailChangeService', () => {
  let data
  let yar
  ...
  describe('when called', () => {
    test('it correctly returns the data', async () => {
      await setBusinessEmailChangeService(changeBusinessEmail, yar)

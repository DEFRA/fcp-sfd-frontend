...
describe('flashNotification', () => {
  ...
  test('returns the standard notification { title: "Updated", text: "Changes made" }', () => {
    ...
    expect(notification).toEqual({ title: 'Updated', text: 'Changes made', html: '<h3 class="govuk-notification-banner__heading">Changes made</h3>' })
  })
  ...
  test('returns the overridden notification { title: "Fancy new title", text: "better text" }', () => {
    ...
    expect(flashType).toEqual('notification')
    expect(notification).toEqual({ title: 'Fancy new title', text: 'better text', html: '<h3 class="govuk-notification-banner__heading">better text</h3>' })
  })
